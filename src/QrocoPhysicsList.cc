...
#include "QrocoMaxTimeCuts.hh"
#include "QrocoMinEkineCuts.hh"
...
// Constructor /////////////////////////////////////////////////////////////
QrocoPhysicsList::QrocoPhysicsList() : G4VUserPhysicsList() 
{
...
// Destructor //////////////////////////////////////////////////////////////
QrocoPhysicsList::~QrocoPhysicsList() 
{;}

// Construct Particles /////////////////////////////////////////////////////
void QrocoPhysicsList::ConstructParticle() 
{
...
// construct Bosons://///////////////////////////////////////////////////
void QrocoPhysicsList::ConstructMyBosons()
{
  // pseudo-particles
...
// construct Leptons://///////////////////////////////////////////////////
void QrocoPhysicsList::ConstructMyLeptons()
{
  // leptons
...
// construct Hadrons://///////////////////////////////////////////////////
void QrocoPhysicsList::ConstructMyHadrons()
{
 //  mesons
...
void QrocoPhysicsList::ConstructMyShortLiveds()
{
...
// Construct Processes //////////////////////////////////////////////////////
void QrocoPhysicsList::ConstructProcess() 
{
  AddTransportation();
...
// Transportation ///////////////////////////////////////////////////////////
void QrocoPhysicsList::AddTransportation() {
  ...
  while( (*particleIterator)() ){
    ...
    if(particleName == "neutron") 
      pmanager->AddDiscreteProcess(new QrocoMaxTimeCuts());
    // Energy cuts to kill charged (embedded in method) particles:
    pmanager->AddDiscreteProcess(new QrocoMinEkineCuts());
...
void QrocoPhysicsList::ConstructEM() {
...
// Optical Processes ////////////////////////////////////////////////////////
void QrocoPhysicsList::ConstructOp() 
{
...
void QrocoPhysicsList::ConstructHad() 
{
  //Elastic models
...
// Decays ///////////////////////////////////////////////////////////////////
void QrocoPhysicsList::ConstructGeneral() {
...
// Cuts /////////////////////////////////////////////////////////////////////
void QrocoPhysicsList::SetCuts() 
{
  
  if (verboseLevel >1)
    G4cout << "QrocoPhysicsList::SetCuts:";
