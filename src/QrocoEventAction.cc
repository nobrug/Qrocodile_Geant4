...
// note QrocoPmtHit.hh and QrocoScintHit.hh are included in QrocoEventAction.hh
...
QrocoEventAction::QrocoEventAction() 
  : runAct(0),genAction(0),hitsfile(0),pmtfile(0)
{

  // create messenger
  eventMessenger = new QrocoEventActionMessenger(this);
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....
void QrocoEventAction::BeginOfEventAction(const G4Event* evt) 
{

  //thread-local run action
  if (!runAct) 
    runAct = 
      dynamic_cast<const QrocoRunAction*>
      (G4RunManager::GetRunManager()->GetUserRunAction());
  
  if (!genAction)
    genAction = dynamic_cast<const QrocoPrimaryGeneratorAction*>
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....
void QrocoEventAction::EndOfEventAction(const G4Event* evt) {
  ...
  QrocoScintHitsCollection* SHC = NULL;
  QrocoPmtHitsCollection*   PHC = NULL;
  G4HCofThisEvent* HCE = evt->GetHCofThisEvent();
  if(HCE) {
    SHC = (QrocoScintHitsCollection*)(HCE->GetHC(scintillatorCollID));
    PHC = (QrocoPmtHitsCollection*)(HCE->GetHC(pmtCollID));
  }
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....
void QrocoEventAction::writeScintHitsToFile() 
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....
void QrocoEventAction::writePmtHitsToFile(const QrocoPmtHitsCollection* hits) 
{ 
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....
void QrocoEventAction::drawTracks(const G4Event* evt) {
