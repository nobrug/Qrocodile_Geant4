...
QrocoMinEkineCuts::QrocoMinEkineCuts(const G4String& aName)
  : QrocoSpecialCuts(aName)
{
    if (verboseLevel>1) {
...
QrocoMinEkineCuts::QrocoMinEkineCuts(QrocoMinEkineCuts&)
  : QrocoSpecialCuts()
{}


G4double QrocoMinEkineCuts::PostStepGetPhysicalInteractionLength(
