...
QrocoMaxTimeCuts::QrocoMaxTimeCuts(const G4String& aName)
...
QrocoMaxTimeCuts::QrocoMaxTimeCuts(QrocoMaxTimeCuts&)
 : QrocoSpecialCuts()
{}

 
G4double QrocoMaxTimeCuts::PostStepGetPhysicalInteractionLength(
