...
QrocoSteppingAction::QrocoSteppingAction()
  : evtAction(0)  {

  steppingMessenger = new QrocoSteppingActionMessenger(this);
...
void QrocoSteppingAction::UserSteppingAction(const G4Step* fStep)
{
  if (!evtAction)
    evtAction = 
      dynamic_cast<const QrocoEventAction*>
